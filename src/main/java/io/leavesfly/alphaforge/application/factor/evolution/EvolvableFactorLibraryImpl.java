...
import io.leavesfly.alphaforge.infrastructure.factor.DefaultFactorLibrary;
...
/**
 * 可进化因子库实现 — 扩展 DefaultFactorLibrary，支持动态注册进化因子
 *
 ...
 */
@Component
@ConditionalOnMissingBean(EvolvableFactorLibrary.class)
public class EvolvableFactorLibraryImpl extends DefaultFactorLibrary implements EvolvableFactorLibrary {

    private static final Logger log = LoggerFactory.getLogger(EvolvableFactorLibraryImpl.class);
    ...
    public EvolvableFactorLibraryImpl(FactorExpressionExecutor expressionExecutor) {
        super();
