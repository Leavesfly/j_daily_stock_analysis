...
/**
 * 因子生成器 Agent 实现 — LLM 驱动的因子自动发现与进化
 *
 * 实现策略：
 ...
 */
@Component
public class FactorGeneratorAgentImpl implements FactorGeneratorAgent {

    private static final Logger log = LoggerFactory.getLogger(FactorGeneratorAgentImpl.class);
    ...
    public FactorGeneratorAgentImpl(LlmPort llmPort,
