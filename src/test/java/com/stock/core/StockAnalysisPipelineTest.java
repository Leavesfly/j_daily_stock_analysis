...
import com.stock.core.StockAnalysisPipeline.AnalysisResult;
import com.stock.core.StockAnalysisPipeline.TrendAnalysisResult;
...
class StockAnalysisPipelineTest {
    ...
    void testDryRun() {
        AnalysisResult result = AnalysisResult.dryRun("600519", "贵州茅台");
